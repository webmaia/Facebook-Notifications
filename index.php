    ...
    <div id="salida">
      ...
      <div class="inner">
        <header>
          ...
          <iframe src="//www.facebook.com/plugins/facepile.php?app_id&amp;href=https%3A%2F%2Fwww.facebook.com%2FGirucode&amp;action=A+comma+separated+list+of+actions+to+show+a+Facepile+for&amp;width=The+pixel+width+of+the+plugin&amp;height=The+pixel+height+of+the+plugin&amp;max_rows=1&amp;colorscheme=dark&amp;size=small&amp;show_count=true&amp;appId=514448035289505" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:The pixel width of the pluginpx; height:The pixel height of the pluginpx;" allowTransparency="true"></iframe>
        </header>
        <footer>
          <?php
            if(@$_GET['live']=='yes') {
